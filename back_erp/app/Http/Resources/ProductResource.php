...
class ProductResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'sell_price'  => (float) $this->price,
            'retail_price'=> (float) $this->price,
            'cost'        => (float) $this->cost,
            'cost_price'  => (float) ($this->purchase_price ?? $this->cost),
            'purchase_price' => (float) ($this->purchase_price ?? $this->cost),
            'qty'         => (float) $this->qty,
