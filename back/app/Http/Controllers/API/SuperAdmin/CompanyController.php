...
class CompanyController extends BaseController
{
    ...
    'email'             => 'required|email|unique:companies',  // إيميل الشركة
    'admin_email'       => 'nullable|email|unique:users,email', // ✅ إيميل الأدمن
    ...
    'password'          => 'nullable|string|min:6',
        ...
        // إنشاء مستخدم مدير للشركة لو أُرسل admin_name
